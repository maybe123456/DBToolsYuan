...
// */
//public abstract class ZPageSickKeyCallback<T> extends ZCallback<T> implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
//
...
//
//
//    public ZPageSickKeyCallback(RecyclerViewAdapter adapter, RecyclerView recyclerView) {
//        adapter.setOnLoadMoreListener(this, recyclerView);
//        mAdapter = adapter;
//    }
//
//    public ZPageSickKeyCallback(RecyclerViewAdapter adapter, RecyclerView recyclerView, INetStatusUI netStatusUI) {
...
//            if (isLoadMore) {
//                    mAdapter.addData((List) ((JokeBean)zResponse.getShowapi_res_body()).getList());
//            } else {
//                mAdapter.setNewData((List) ((JokeBean)zResponse.getShowapi_res_body()).getList());
//            }
