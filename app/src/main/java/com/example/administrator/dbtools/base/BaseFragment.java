...
import com.example.administrator.dbtools.base.network.INetStatusUI;
import com.example.administrator.dbtools.base.view.TitleBar;
import com.example.administrator.dbtools.databinding.FragmentBaseBinding;
...
//    }
    ...
    public void setTitleLeft(boolean isShow ,String src){
        if(mBaseBinding != null){
            ((TitleBar)mBaseBinding.getRoot().findViewById(R.id.titlebar_frag)).showLeft(isShow);
            ((TitleBar)mBaseBinding.getRoot().findViewById(R.id.titlebar_frag)).setLeft(src);
        }
    }
